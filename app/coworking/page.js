...
.wf-top-with-requests { display: grid; grid-template-columns: 1fr 320px; gap: 16px; margin-bottom: 16px; align-items: stretch; }
        ...
        <div className="wf-inner">
          ...
          <div className="wf-top-with-requests">
            <div className="wf-top-left">
              ...
              <div className="wf-card" style={{ display: "flex", flexDirection: "column", overflow: "hidden", flex: "1 1 auto" }}>
                {/* Header */}
