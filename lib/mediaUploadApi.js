...
// Tasks
export async function createTask({ title, description, notes, assigneeIds, dueDate, priority, parentTaskId, createdByRole, createdBy, createdByCeo, createdByTl, status, isFolder, isRepeat, repeatConfig, isThirdParty, thirdPartyConfig, isGoal, goalConfig }) {
    const d = await api("/cowork/task/create", {
        method: "POST",
        body: JSON.stringify({ title, description, notes, assigneeIds, dueDate, priority, parentTaskId: parentTaskId || null, createdByRole, createdBy, createdByCeo, createdByTl, status, isFolder: isFolder || false, isRepeat: isRepeat || false, repeatConfig: repeatConfig || null, isThirdParty: isThirdParty || false, thirdPartyConfig: thirdPartyConfig || null, isGoal: isGoal || false, goalConfig: goalConfig || null }),
    });
    return d.task;
}
