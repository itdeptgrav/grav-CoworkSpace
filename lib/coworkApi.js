...
export const fetchAllSopCategories = () => coworkFetch("/sop/all-categories"); export const createSop = (body) => coworkFetch("/sop", { method: "POST", body: JSON.stringify(body) });
...
export const getPmpEmployees = () => coworkFetch("/pmp/employees");
export const getPmpDashboard = (empId, q, y) => coworkFetch(`/pmp/${empId}/dashboard?quarter=${q}&year=${y}`);
...
export const getWorkloadSummary = () => coworkFetch(`/workload/summary?t=${Date.now()}`);
export const getEmployeeCalendar = (employeeId) => coworkFetch(`/workload/employee/${employeeId}/calendar`);
