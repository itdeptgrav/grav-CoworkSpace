            ...
            {recording ? (
                ...
                <div style={{ display: "flex", alignItems: "flex-end", padding: "8px 10px", gap: 6, minHeight: 56 }}>
                    ...
                    <textarea
                        ...
                        style={{ flex: 1, background: "#2A3942", border: "none", outline: "none", color: "#1c92f3", fontSize: 13, padding: "8px 14px", borderRadius: 24, resize: "none", fontFamily: "inherit", lineHeight: 1.5, maxHeight: 100, overflowY: "auto", boxSizing: "border-box", caretColor: "#00A884" }}
